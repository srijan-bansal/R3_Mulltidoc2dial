...
class Collator(object):
    def __init__(self, text_maxlength, tokenizer, answer_maxlength=20, question_maxlength=100):
    ...
    def __call__(self, batch):
        ...
        def append_question(example):
            ...
            example['question'] = ' '.join(example['question'].split(' ')[:self.question_maxlength])
