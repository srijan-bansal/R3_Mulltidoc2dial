...
class Options():
    ...
    def add_eval_options(self):
        ...
        self.parser.add_argument('--train', action='store_true', help='whether to train or evaluate')
        self.parser.add_argument('--evaluate', action='store_true', help='whether to train or evaluate')
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--question_maxlength', type=int, default=100, 
                        help='maximum number of question words to train the model')
        ...
        self.parser.add_argument('--output_maxlength', type=int, default=50, 
                        help='maximum number of tokens used to output')
        ...
        self.parser.add_argument('--num_beams', type=int, default=None)
        self.parser.add_argument('--num_return_sequences', type=int, default=None)
        self.parser.add_argument('--output_file', type=str, default=None)
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument('--ispretrained', action='store_true')
        # dataset parameters
        ...
        self.parser.add_argument('--is_distributed', type=bool, default=False)
        ...
        # training parameters
        self.parser.add_argument('--eval_freq', type=int, default=2500,
                        help='evaluate model every <eval_freq> steps during training')
        self.parser.add_argument('--save_freq', type=int, default=2500,
                        help='save model every <save_freq> steps during training')
        self.parser.add_argument('--eval_print_freq', type=int, default=2500,
